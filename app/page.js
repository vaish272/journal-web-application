    ...
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      <div className="max-w-5xl mx-auto text-center space-y-8">
        ...
        <p className="text-lg md:text-xl text-orange-800 mb-8">
          Capture your thoughts, track your moods, and journal out your journey in a beautiful, secure space.
        </p>
        <div className="relative">
          ...
          <div className="bg-white rounded-2xl p-4 max-full mx-auto">
            ...
            <div className="space-y-4 p-4">
              ...
              <Skeleton className="h-4 bg-orange-100 rounded full" />
          ...
          <Card className="bg-gradient-to-r from-orange-100 to-amber-100">
            <CardContent className="p-12 text-center">
              <h2 className="text-3xl font-bold text-orange-900 mb-6">
                Start JournalingOut Your Thoughts Today
              </h2>
